-- Active: 1758114171478@@AUDREY_LAPTOP@1433@Fabys_Unhas
...
create table Profissionais_Beleza
	(
--		Nome		Tipo		Nulo/N�o Nulo	Chave-Primaria	Auto-Incremento		Unico	,
		pessoa_id	int			not null		primary key									,
...
--		Nome			Tipo			Nulo/N�o Nulo	Chave-Primaria	Auto-Incremento		Unico	,
		...
		foreign key(profissional_id) references Profissionais_Beleza(pessoa_id)
	)
go
