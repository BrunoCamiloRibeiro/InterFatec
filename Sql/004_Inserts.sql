...
('Ana Clara', '11988880001'), 
('Bruno Costa', '11988880002'), 
('Carla Dias', '11988880003'),
('Daniela Silva', '11988880004'), 
('Eduardo Lima', '11988880005'), 
('Fernanda Alves', '11988880006'),
('Gabriela Santos', '11988880007'), 
('Helena Souza', '11988880008'), 
('Igor Martins', '11988880009'),
('Juliana Rocha', '11988880010'), 
('Karla Mendes', '11988880011'), 
('Lucas Ferreira', '11988880012'),
('Marcos Silva', '11988880013'), 
('Nathalia Ribeiro', '11988880014'), 
('Otavio Pires', '11988880015'),
('Patricia Castro', '11988880016'), 
('Quiriana Gomes', '11988880017'), 
('Rafaela Moraes', '11988880018'),
('Sabrina Nunes', '11988880019'), 
('Tatiana Barros', '11988880020'),
('Ursula Farias', '11988880021'), 
('Valeria Pinto', '11988880022'), 
('Wagner Melo', '11988880023'),
('Xenia Viana', '11988880024'), 
('Yara Teixeira', '11988880025'), 
('Zelia Dantas', '11988880026'),
('Alice Carvalho', '11988880027'), 
('Breno Nogueira', '11988880028'), 
('Camila Borges', '11988880029'),
('Diego Leite', '11988880030'), 
('Elisa Monteiro', '11988880031'), 
('Fabio Tavares', '11988880032'),
('Giovana Lemos', '11988880033'), 
('Hugo Resende', '11988880034'), 
('Isabela Macedo', '11988880035'),
('Joao Batista', '11988880036'), 
('Karen Peixoto', '11988880037'), 
('Leonardo Guedes', '11988880038'),
('Marcos Vianna', '11988880039'), 
('Neide Camargo', '11988880040');

-- Assumindo que os IDs 1 a 20 são Clientes
...
-- Assumindo que os IDs 21 a 40 são Funcionários
...
(31, 3200.00, 11), (32, 2900.00, 12), (33, 1900.00, 13), (34, 1800.00, 14), (35, 2100.00, 15), 
(36, 2500.00, 16), (37, 2700.00, 17), (38, 2000.00, 18), (39, 1700.00, 19), (40, 1500.00, 20);
...
INSERT INTO Produtos (nome, marca_id, preco, PathImagem) VALUES
...
-- ==========================================
-- GRUPO 4: Agendamentos, Servicos_Agendados, Produtos_Agendados
-- ==========================================

INSERT INTO Agendamentos (data, total, cliente_id, status) VALUES
('2026-05-10', 35.00, 1, 2), ('2026-05-11', 40.00, 2, 2), ('2026-05-12', 70.00, 3, 0),
('2026-05-13', 150.00, 4, 0), ('2026-05-14', 130.00, 5, 0), ('2026-05-15', 80.00, 6, 0),
('2026-05-16', 60.00, 7, 1), ('2026-05-17', 40.00, 8, 1), ('2026-05-18', 55.00, 9, 1),
('2026-05-19', 85.00, 10, 1), ('2026-05-20', 25.00, 11, 0), ('2026-05-21', 45.00, 12, 0),
('2026-05-22', 15.00, 13, 0), ('2026-05-23', 20.00, 14, 0), ('2026-05-24', 10.00, 15, 2),
('2026-05-25', 90.00, 16, 1), ('2026-05-26', 45.00, 17, 1), ('2026-05-27', 50.00, 18, 1),
('2026-05-28', 30.00, 19, 0), ('2026-05-29', 35.00, 20, 1), ('2026-05-30', 99.00, 20, 1);
...
(8, 8, 'Dói um pouco a unha do dedinho', '10:30:00', 26, 40.00),
...
(20, 1, 'Cliente pediu esmalte vermelho', '12:00:00', 21, 35.00);
