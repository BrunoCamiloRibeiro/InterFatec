...
-- ==========================================
EXEC sp_InsertCliente @Nome = 'Ana Clara',     @Telefone = '11988880001', @Senha = 'senha123';
EXEC sp_InsertCliente @Nome = 'Bruno Costa',   @Telefone = '11988880002', @Senha = 'senha123';
EXEC sp_InsertCliente @Nome = 'Carla Dias',    @Telefone = '11988880003', @Senha = 'senha123';
EXEC sp_InsertCliente @Nome = 'Daniela Silva', @Telefone = '11988880004', @Senha = 'senha123';
EXEC sp_InsertCliente @Nome = 'Eduardo Lima',  @Telefone = '11988880005', @Senha = 'senha123';
EXEC sp_InsertCliente @Nome = 'Fernanda Alves',@Telefone = '11988880006', @Senha = 'senha123';
EXEC sp_InsertCliente @Nome = 'Gabriela Santos',@Telefone = '11988880007', @Senha = 'senha123';
EXEC sp_InsertCliente @Nome = 'Helena Souza',  @Telefone = '11988880008', @Senha = 'senha123';
EXEC sp_InsertCliente @Nome = 'Igor Martins',  @Telefone = '11988880009', @Senha = 'senha123';
EXEC sp_InsertCliente @Nome = 'Juliana Rocha', @Telefone = '11988880010', @Senha = 'senha123';
EXEC sp_InsertCliente @Nome = 'Karla Mendes',  @Telefone = '11988880011', @Senha = 'senha123';
