...
-- ==========================================
-- 2. CLIENTES (As pessoas são criadas automaticamente)
-- ==========================================
EXEC sp_InsertCliente @Nome = 'Ana Clara', @Telefone = '11988880001';
EXEC sp_InsertCliente @Nome = 'Bruno Costa', @Telefone = '11988880002';
EXEC sp_InsertCliente @Nome = 'Carla Dias', @Telefone = '11988880003';
EXEC sp_InsertCliente @Nome = 'Daniela Silva', @Telefone = '11988880004';
EXEC sp_InsertCliente @Nome = 'Eduardo Lima', @Telefone = '11988880005';
EXEC sp_InsertCliente @Nome = 'Fernanda Alves', @Telefone = '11988880006';
EXEC sp_InsertCliente @Nome = 'Gabriela Santos', @Telefone = '11988880007';
EXEC sp_InsertCliente @Nome = 'Helena Souza', @Telefone = '11988880008';
EXEC sp_InsertCliente @Nome = 'Igor Martins', @Telefone = '11988880009';
EXEC sp_InsertCliente @Nome = 'Juliana Rocha', @Telefone = '11988880010';
EXEC sp_InsertCliente @Nome = 'Karla Mendes', @Telefone = '11988880011';
EXEC sp_InsertCliente @Nome = 'Lucas Ferreira', @Telefone = '11988880012';
EXEC sp_InsertCliente @Nome = 'Marcos Silva', @Telefone = '11988880013';
EXEC sp_InsertCliente @Nome = 'Nathalia Ribeiro', @Telefone = '11988880014';
EXEC sp_InsertCliente @Nome = 'Otavio Pires', @Telefone = '11988880015';
EXEC sp_InsertCliente @Nome = 'Patricia Castro', @Telefone = '11988880016';
EXEC sp_InsertCliente @Nome = 'Quiriana Gomes', @Telefone = '11988880017';
EXEC sp_InsertCliente @Nome = 'Rafaela Moraes', @Telefone = '11988880018';
EXEC sp_InsertCliente @Nome = 'Sabrina Nunes', @Telefone = '11988880019';
EXEC sp_InsertCliente @Nome = 'Tatiana Barros', @Telefone = '11988880020';
GO

-- ==========================================
-- 3. FUNCIONÁRIOS (Unindo Dados de Pessoas e Salários)
-- ==========================================
EXEC sp_InsertFuncionario @Nome = 'Ursula Farias', @Telefone = '11988880021', @Salario = 2500.00, @Especialidade_Id = 1;
EXEC sp_InsertFuncionario @Nome = 'Valeria Pinto', @Telefone = '11988880022', @Salario = 2600.00, @Especialidade_Id = 2;
EXEC sp_InsertFuncionario @Nome = 'Wagner Melo', @Telefone = '11988880023', @Salario = 3500.00, @Especialidade_Id = 3;
EXEC sp_InsertFuncionario @Nome = 'Xenia Viana', @Telefone = '11988880024', @Salario = 3800.00, @Especialidade_Id = 4;
EXEC sp_InsertFuncionario @Nome = 'Yara Teixeira', @Telefone = '11988880025', @Salario = 2200.00, @Especialidade_Id = 5;
EXEC sp_InsertFuncionario @Nome = 'Zelia Dantas', @Telefone = '11988880026', @Salario = 3000.00, @Especialidade_Id = 6;
EXEC sp_InsertFuncionario @Nome = 'Alice Carvalho', @Telefone = '11988880027', @Salario = 2800.00, @Especialidade_Id = 7;
EXEC sp_InsertFuncionario @Nome = 'Breno Nogueira', @Telefone = '11988880028', @Salario = 3100.00, @Especialidade_Id = 8;
EXEC sp_InsertFuncionario @Nome = 'Camila Borges', @Telefone = '11988880029', @Salario = 3600.00, @Especialidade_Id = 9;
EXEC sp_InsertFuncionario @Nome = 'Diego Leite', @Telefone = '11988880030', @Salario = 4000.00, @Especialidade_Id = 10;
EXEC sp_InsertFuncionario @Nome = 'Elisa Monteiro', @Telefone = '11988880031', @Salario = 3200.00, @Especialidade_Id = 11;
EXEC sp_InsertFuncionario @Nome = 'Fabio Tavares', @Telefone = '11988880032', @Salario = 2900.00, @Especialidade_Id = 12;
EXEC sp_InsertFuncionario @Nome = 'Giovana Lemos', @Telefone = '11988880033', @Salario = 1900.00, @Especialidade_Id = 13;
EXEC sp_InsertFuncionario @Nome = 'Hugo Resende', @Telefone = '11988880034', @Salario = 1800.00, @Especialidade_Id = 14;
EXEC sp_InsertFuncionario @Nome = 'Isabela Macedo', @Telefone = '11988880035', @Salario = 2100.00, @Especialidade_Id = 15;
EXEC sp_InsertFuncionario @Nome = 'Joao Batista', @Telefone = '11988880036', @Salario = 2500.00, @Especialidade_Id = 16;
EXEC sp_InsertFuncionario @Nome = 'Karen Peixoto', @Telefone = '11988880037', @Salario = 2700.00, @Especialidade_Id = 17;
EXEC sp_InsertFuncionario @Nome = 'Leonardo Guedes', @Telefone = '11988880038', @Salario = 2000.00, @Especialidade_Id = 18;
EXEC sp_InsertFuncionario @Nome = 'Marcos Vianna', @Telefone = '11988880039', @Salario = 1700.00, @Especialidade_Id = 19;
EXEC sp_InsertFuncionario @Nome = 'Neide Camargo', @Telefone = '11988880040', @Salario = 1500.00, @Especialidade_Id = 20;
GO
...
-- Segundo serviço associado ao agendamento 20:
